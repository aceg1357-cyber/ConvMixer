...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # 96
        # 举个例子:序列长度97,seg长度12,则pad长度为108
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        x_enc:(32,96,7)
        """
        # embedding,采用和PatchTST相同的PatchEmbedding(包含切分patch+序列长度扩展+位置编码)
        # x_enc:(32,96,7)->(32,7,8,12)->(224,8,12)->(224,8,512)
        # n_vars:7
        x_enc, n_vars = self.enc_value_embedding(x_enc.permute(0, 2, 1))
        # 改变形状
        # x_enc:(224,8,512)->(32,7,8,512)
        x_enc = rearrange(x_enc, '(b d) seg_num d_model -> b d seg_num d_model', d = n_vars)
        # 增加可学习位置编码
        # (32,7,8,512)+(1,7,8,512)->(32,7,8,512)
